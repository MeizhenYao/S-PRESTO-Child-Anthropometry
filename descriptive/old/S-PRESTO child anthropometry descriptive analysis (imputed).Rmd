---
title: "S-PRESTO child anthropometry descriptive analysis (imputed)"
author: "Meizhen Yao"
date: "`r Sys.Date()`"
output:
  html_document:
...
#-------------------------------------------------------import data set
blood_child_who_stan<- read_csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Documents/Projects/S-PRESTO/input/anthropometry/blood_child_who_stan_04172023.csv")


 


label(blood_child_who_stan$weight_del_CN)<- "Weight at Delivery (from hospital Casenotes) (g)"
label(blood_child_who_stan$weight_del)<- "Weight  at Delivery (from RC) (g)"
label(blood_child_who_stan$weight_wk1)<- "Weight at Week 1 (g)"
label(blood_child_who_stan$weight_wk3)<- "Weight at Week 3 (g)"
label(blood_child_who_stan$weight_wk6)<- "Weight at Week 6 (g)"
label(blood_child_who_stan$weight_m3)<- "Weight  at Week at Month 3 (g)" 
label(blood_child_who_stan$weight_m6)<- "Weight  at Week at Month 6 (g)"
label(blood_child_who_stan$weight_m12)<- "Weight  at Week at Month 12 (g)"
label(blood_child_who_stan$weight_m18)<- "Weight  at Week at Month 18 (g)"
label(blood_child_who_stan$length_del_CN)<- "Length at Delivery (from Casenotes) (cm)"
label(blood_child_who_stan$length_del)<- "Length at Delivery (from RC) (cm)"
label(blood_child_who_stan$length_wk1)<- "Length at Week 1 (cm)"
label(blood_child_who_stan$length_wk3)<- "Length at Week 3 (cm)"
label(blood_child_who_stan$length_wk6)<- "Length at Week 6 (cm)"
label(blood_child_who_stan$length_m3)<- "Length at Month 3 (cm)"
label(blood_child_who_stan$length_m6)<- "Length at Month 6 (cm)"
label(blood_child_who_stan$length_m12)<- "Length at Month 12 (cm)"
label(blood_child_who_stan$length_m18)<- "Length at Month 18 (cm)"
label(blood_child_who_stan$Days_since_birth_del)<- "Days Since Birth"
label(blood_child_who_stan$Days_since_birth_wk1)<- "Days Since Birth at Week 1"
label(blood_child_who_stan$Days_since_birth_wk3)<- "Days Since Birth at Week 3"
label(blood_child_who_stan$Days_since_birth_wk6)<- "Days Since Birth at Week 6"
label(blood_child_who_stan$Days_since_birth_m3)<- "Days Since Birth at Month 3"
label(blood_child_who_stan$Days_since_birth_m6)<- "Days Since Birth at Month 6"
label(blood_child_who_stan$Days_since_birth_m12)<- "Days Since Birth at Month 12"
label(blood_child_who_stan$Days_since_birth_m18)<- "Days Since Birth at Month 18"
